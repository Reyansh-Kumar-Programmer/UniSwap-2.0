...
const style = {
  wrapper: `overflow-scroll h-full text-white select-none h-full w-screen flex-1 pt-14 flex items-end justify-end pb-2 overflow-scroll px-8`,
          ...
          transactionHistory?.map((transaction, index) => (
            <div className={style.txHistoryItem} key={index}>
              <div className={style.txDetails}>
                <Image className="pr-1" src={ethLogo} height={20} width={15} alt="eth" />
                {transaction.amount} Ξ sen to{" "}
